...
# File from: https://github.com/libcpr/cpr/blob/1.10.0/cmake/sanitizer.cmake
# License (MIT) is no problem since I (Fabian Sauter) am the original author of this file.
...
if(NOT CMAKE_CROSSCOMPILING)
    ...
    if(PULP_UI_DEBUG_SANITIZER_FLAG_THREAD AND THREAD_SANITIZER_AVAILABLE)
    ...
    elseif(PULP_UI_DEBUG_SANITIZER_FLAG_ADDR AND ADDRESS_SANITIZER_AVAILABLE)
    ...
    elseif(PULP_UI_DEBUG_SANITIZER_FLAG_LEAK AND LEAK_SANITIZER_AVAILABLE)
    ...
    elseif(PULP_UI_DEBUG_SANITIZER_FLAG_UB AND UNDEFINED_BEHAVIOUR_SANITIZER_AVAILABLE)
        ...
        message(STATUS "Undefined behaviour sanitizer activated.")
    elseif(PULP_UI_DEBUG_SANITIZER_FLAG_ALL AND ALL_SANITIZERS_AVAILABLE)
        ...
        message(STATUS "All available sanitizers activated.")
    endif()
endif()
