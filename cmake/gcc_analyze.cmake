...
if(PULP_UI_STATIC_ANALYZE)
    if(PULP_UI_ENABLE_LINTING)
        message(FATAL_ERROR "Linting and the GCC static analysis can not be enabled at the same time! Disable either PULP_UI_STATIC_ANALYZE or PULP_UI_ENABLE_LINTING.")
    endif()
